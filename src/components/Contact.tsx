            ...
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:mvinodkumar202@gmail.com"   className="text-gray-600 hover:text-indigo-600 transition-colors">
                      mvinodkumar202@gmail.com
                    </a>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-indigo-600 text-white p-2 rounded-full hover:bg-indigo-700 transition-colors">
                  ...
                  <a href="https://github.com/mvinodkumar9381"  target="_blank"  className="bg-indigo-600 text-white p-2 rounded-full hover:bg-indigo-700 transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
